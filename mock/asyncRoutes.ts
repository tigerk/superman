  ...
  children: [
    {
      ...
      children: [
        {
          path: "/platform/company/list/index",
          component: "/platform/company/list/index",
        ...
        {
          path: "/platform/company/package/index",
          component: "/platform/company/package/index",
          name: "PlatformCompanyPackage",
          meta: {
