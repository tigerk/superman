    ...
    <template #header>
      <div class="card-header">
        <span class="font-medium">
          拖拽组件，采用开源的
          <el-link href="https://sortablejs.github.io/vue.draggable.next/#/simple" target="_blank" style="margin: 0 4px 5px; font-size: 16px">vuedraggable</el-link>
        </span>
      </div>
      <el-link class="mt-2" href="https://github.com/pure-admin/vue-pure-admin/blob/main/src/views/able/draggable.vue" target="_blank">
      ...
      <el-row :gutter="25">
        ...
        <el-col :xs="25" :sm="8" :md="8" :lg="8">
          <el-card shadow="never">
            ...
            <!-- 单列拖拽 -->
            <draggable v-model="lists" item-key="name" chosen-class="chosen" force-fallback="true" animation="300" @change="change">
