...
<template>
  <el-card shadow="never" :body-style="{ padding: '20px' }">
    <template #header>
      ...
      <el-link class="mt-2" href="https://github.com/pure-admin/vue-pure-admin/blob/main/src/views/able/mqtt-client.vue" target="_blank">
      ...
      <el-form label-position="top" :model="connection">
        <el-row :gutter="20">
          ...
          <el-col :span="24">
            ...
            <el-button v-if="client.connected" type="danger" :loading="btnLoadingType === 'disconnect'" @click="destroyConnection">断开连接</el-button>
          </el-col>
        </el-row>
      </el-form>
    </el-card>
    ...
    <el-card shadow="never" class="mt-4">
      ...
      <el-col :span="24">
        <el-button type="primary" :loading="btnLoadingType === 'publish'" :disabled="!client.connected" @click="doPublish">发布</el-button>
      </el-col>
    </el-card>
    <el-card shadow="never" class="mt-4">
      <h1>接收</h1>
