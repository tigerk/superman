  ...
  <el-card shadow="never">
    <template #header>
      <div class="card-header">
        ...
        <el-link class="mt-2" href="https://github.com/pure-admin/vue-pure-admin/blob/main/src/views/able/directives.vue" target="_blank">
    ...
    <div class="mb-2">
      ...
      <el-input v-model="searchFour" v-optimize:throttle="{ event: 'input', fn: onInputFour, timeout: 1000 }" class="w-[200px]!" clearable />
    </div>
    <div>
