    ...
    <el-row :gutter="30">
      <re-col>
        <el-form-item label="字典标签" prop="name">
          <el-input v-model="newFormInline.name" clearable placeholder="请输入字典标签" />
        </el-form-item>
      </re-col>
      <re-col>
      ...
      <re-col>
        <el-form-item label="备注">
          <el-input v-model="newFormInline.remark" placeholder="请输入备注信息" maxlength="200" :rows="3" show-word-limit type="textarea" />
        </el-form-item>
      </re-col>
    </el-row>
  </el-form>
